...
%loop for each image in the folder
    for k = 1 : length(images_list1.dir)
        ...
        for Vdd_mod = 10:1:14
            ...
            %ORIGINAL ONLY DVS
            temp_image_saturated = displayed_image(images_list1.IPanel_original(k).Ipanel,Vdd_mod,SATURATED);
            temp_image_distorted = displayed_image(images_list1.IPanel_original(k).Ipanel,Vdd_mod,DISTORTED);
            %evaluate power
            ...
            %apply DVS
            temp_image_saturated = displayed_image(images_list1.Ipanel_brightness_scaling(k).transf(index).Ipanel,Vdd_mod,SATURATED);
            temp_image_distorted = displayed_image(images_list1.Ipanel_brightness_scaling(k).transf(index).Ipanel,Vdd_mod,DISTORTED);
            %evaluate power
            ...
            %apply DVS
            temp_image_saturated = displayed_image(images_list1.Ipanel_contrast_enhancement(k).transf(index).Ipanel,Vdd_mod,SATURATED);
            temp_image_distorted = displayed_image(images_list1.Ipanel_contrast_enhancement(k).transf(index).Ipanel,Vdd_mod,DISTORTED);
            %evaluate power
            ...
            %apply DVS
            temp_image_saturated = displayed_image(images_list1.Ipanel_combined(k).transf(index).Ipanel,Vdd_mod,SATURATED);
            temp_image_distorted = displayed_image(images_list1.Ipanel_combined(k).transf(index).Ipanel,Vdd_mod,DISTORTED);
            %evaluate power
