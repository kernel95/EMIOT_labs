...
file = open("simulator_results/results_sleep_w2.txt","w+")
...
file_savings = open("Energy_w_dpm/dpm_energy_sleep_w2.txt","w+")

#file_savings.write("timeout value,  Energy w DPM \n")

with open('simulator_results/results_sleep_w2.txt') as temp_f:
