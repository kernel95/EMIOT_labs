...
fig.set_size_inches(14, 10, forward=True) #25 e 35 prima

file = open("simulator_results/results_sleep_w0.txt","w+")
...
file_savings = open("Energy_w_dpm/dpm_energy_sleep_w0.txt","w+")

#file_savings.write("timeout value,  Energy w DPM \n")

with open('simulator_results/results_sleep_w0.txt') as temp_f:
...
file_best = open("best_result/best_dpm_sleep_w0.txt","w")
...
n = 0
with open('Energy_w_dpm/dpm_energy_sleep_w0.txt') as temp_f:   #for each line in the file that contains pair TIMEOUT, ENERGY W DPM
...
plt.savefig('printed_graphs/dpm_sleep_w0.png')
...
plt.savefig('printed_graphs/saved_energy_sleep_w0.png')
