...
file = open("simulator_results/results_sleep_w1.txt","w+")
...
file_savings = open("Energy_w_dpm/dpm_energy_sleep_w1.txt","w+")

#file_savings.write("timeout value,  Energy w DPM \n")

with open('simulator_results/results_sleep_w1.txt') as temp_f:
...
file_best = open("best_result/best_dpm_sleep_w1.txt","w")
...
plt.savefig('printed_graphs/saved_energy_sleep_w1.png')
